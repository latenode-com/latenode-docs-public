...
![brave_DaNUFOQFju.png](./using-ai-to-generate-code-ai-node/brave_danufoqfju.png)

**2.Inside any JavaScript node**. Open the node and enter your message to start a conversation.

![brave_cQKGx7lnsr.png](./using-ai-to-generate-code-ai-node/brave_cqkgx7lnsr.png)
...
![brave_uRQZri9TRV.png](./using-ai-to-generate-code-ai-node/brave_urqzri9trv.png)
...
> **Note:** It is assumed that global variables GlobalVar_number1 and GlobalVar_number2 exist in the account. See the section on global variables.
