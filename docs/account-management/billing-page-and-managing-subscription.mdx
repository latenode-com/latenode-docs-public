...
![vivaldi_gOlPINdrop.png](./billing-page-and-managing-subscription/vivaldi_golpindrop.png)
...
![vivaldi_jn17OX1S4k.png](./billing-page-and-managing-subscription/vivaldi_jn17ox1s4k.png)
...
1. Click **Manage payments**
    ...
    ![vivaldi_LbWeQCHOCY.png](./billing-page-and-managing-subscription/vivaldi_lbweqchocy.png)
    
2. The Stripe interface will open
3. Find the active subscription
4. Disable auto-renew or cancel the subscription completely

![vivaldi_Jn73O5V5lo.png](./billing-page-and-managing-subscription/vivaldi_jn73o5v5lo.png)
