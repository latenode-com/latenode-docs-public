---
title: Build your first scenario (archive)
description: Legacy quickstart (Gmail trigger + AI). Prefer "Your first scenario in 15 minutes" in Quickstarts.
sidebar_position: 2
lastUpdated: '2026-04-10'
---

# Build your first scenario (archive)

<Callout type="warning" title="Archived quickstart">
This page is kept for old links. For a current walkthrough, start with [Your first scenario in 15 minutes](/get-started/quickstarts/first-scenario) or [How Latenode works](/get-started/quickstarts/how-it-works).
</Callout>
