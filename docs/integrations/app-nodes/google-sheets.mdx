...
| Field | Description |
| --- | --- |
| Connection | Google Sheets account |
| Drive ID | Drive that contains the spreadsheet |
| Spreadsheet ID | Spreadsheet to watch |
...
| Field | Description |
| --- | --- |
| Connection | Google Sheets connection |
| Drive ID | Drive with the spreadsheet |
...
| Spreadsheet ID | Source spreadsheet |
...
| Connection | Google Sheets connection |
| Drive ID | Drive with the spreadsheet |
| Spreadsheet ID | Spreadsheet to list |
