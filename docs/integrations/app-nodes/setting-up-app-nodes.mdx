...
description: How file and folder pickers work in app nodes—loading, search, and labels.
lastUpdated: '2026-03-31'
---

# Setting up App Nodes

When an app node needs a file or folder, you get a list with paging and search. Below is how it looks using the **Delete File** node in **Google Drive** as an example.

![Delete File node](./setting-up-app-nodes/Untitled.png)

After you click the picker field:
