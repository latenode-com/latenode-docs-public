...
![Untitled](./http-request/untitled.png)
...
![brave_qmd1FjaegH.png](./http-request/brave_qmd1fjaegh.png)
...
![brave_9UDYz3uyVB.png](./http-request/brave_9udyz3uyvb.png)
...
![brave_DrFvMPYCCL.png](./http-request/brave_drfvmpyccl.png)

### **Body**

The block of fields for configuring and filling in the request body includes:  

![brave_KSVXnu8vRP.png](./http-request/brave_ksvxnu8vrp.png)
...
![brave_uTnyCtlTeV.png](./http-request/brave_utnyctltev.png)
...
![brave_YPKF70KhOm.png](./http-request/brave_ypkf70khom.png)
...
![brave_lHFn9bRWCs.png](./http-request/brave_lhfn9brwcs.png)
