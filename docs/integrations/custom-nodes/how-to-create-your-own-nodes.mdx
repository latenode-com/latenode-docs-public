...
![Untitled](./how-to-create-your-own-nodes/untitled.png)
...
![Untitled 1](./how-to-create-your-own-nodes/untitled_1.png)
...
![Untitled 2](./how-to-create-your-own-nodes/untitled_2.png)

- Add a **Webhook Response** node to return a response upon scenario execution**;**

![Untitled 3](./how-to-create-your-own-nodes/untitled_3.png)
...
![QuickLook](./how-to-create-your-own-nodes/quicklook_llgjlaktlc.png)

**Tip:** You can add XML code for the icon in the "Icon (svg)" field to make the scenario easier to identify.

![Untitled 4](./how-to-create-your-own-nodes/untitled_4.png)



3. Change the current scenario name "String to Table" to "Al Tools/Actions/GoogleSheetAddRow";

![Brave](./how-to-create-your-own-nodes/brave_lkgkcfkouy.png)

> **Note:** The "Al Tools/Actions" part of the name is necessary for storing the scenario as an **Action** node in the Al Tools folder.



4. Change the scenario type to **Nodul**;

![Untitled 5](./how-to-create-your-own-nodes/untitled_5.png)

> **Note:** Next to the scenario name, after changing the type, icons are used to denote "Nodul" (a sign of a **Nodul** type scenario) and "Private" (indicating no public access to the scenario).



![Brave 1](./how-to-create-your-own-nodes/brave_lkgkcfkouy_1.png)
...
![Untitled 6](./how-to-create-your-own-nodes/untitled_6.png)
...
![Untitled 7](./how-to-create-your-own-nodes/untitled_7.png)

7. Add the execution result of the "Ok" scenario to the **Result** field of the **NodulOutput** node.

![QuickLook 2](./how-to-create-your-own-nodes/quicklook_7ofzdsdbuw.png)
...
![Untitled 8](./how-to-create-your-own-nodes/untitled_8.png)
...
![Untitled 9](./how-to-create-your-own-nodes/untitled_9.png)
...
![Untitled 12](./how-to-create-your-own-nodes/untitled_12.png)
...
![Untitled 13](./how-to-create-your-own-nodes/untitled_13.png)
