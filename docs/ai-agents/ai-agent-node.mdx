...
![CleanShot 2025-05-16 at 18.38.18.png](./ai-agent-node/cleanshot_20250516_at_18.38.18.png)
...
![brave_fvEXfL38jp.png](./ai-agent-node/brave_fvexfl38jp.png)
...
![brave_xNNZGPqEGq.png](./ai-agent-node/brave_xnnzgpqegq.png)
...
![brave_9uh4VMBrnf.png](./ai-agent-node/brave_9uh4vmbrnf.png)
...
- **Tool metadata** — each connected node must provide:
    ...
    ![brave_oShdIMhDhh.png](./ai-agent-node/brave_oshdimhdhh.png)
...
![brave_sIdzBuBDiw.png](./ai-agent-node/brave_sidzbubdiw.png)
...
![brave_ZlaQrPlTp8.png](./ai-agent-node/brave_zlaqrpltp8.png)
...
![brave_xiqvZfU4oX.png](./ai-agent-node/brave_xiqvzfu4ox.png)
...
![brave_h72MlkiWPY.png](./ai-agent-node/brave_h72mlkiwpy.png)
...
![brave_dhJzbkPo2S.png](./ai-agent-node/brave_dhjzbkpo2s.png)
...
![brave_ahtqYMQUqg.png](./ai-agent-node/brave_ahtqymquqg.png)
...
![brave_kclShZkQHU.png](./ai-agent-node/brave_kclshzkqhu.png)
...
![brave_68lN7zAoQd.png](./ai-agent-node/brave_68ln7zaoqd.png)

- If the user asks to create note, it uses the `Create Note`node.

![brave_cua2kt18nf.png](./ai-agent-node/brave_cua2kt18nf.png)
...
![brave_lL4T52yY0g.png](./ai-agent-node/brave_ll4t52yy0g.png)
...
![brave_TStf2Ey04h.png](./ai-agent-node/brave_tstf2ey04h.png)
