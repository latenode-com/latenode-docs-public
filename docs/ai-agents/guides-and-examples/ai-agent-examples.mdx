...
![brave_ox4ExaprKc.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
![brave_pVlu6L7Qpm.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
![brave_WHvrQ9Gm7U.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
**Tip:** This scenario is great for lightweight assistants that respond contextually without complex logic trees.
...
![brave_YsvXfPjJun.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
- `main_agent` sends:
    ...
    ![brave_Jx7QglHbem.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
- Agent parses:
    ...
    ![brave_DWImZg8xtM.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
**Tip:** This pattern fits well for scalable assistants, where logic needs to be cleanly split.
...
![brave_hY65yK91HG.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
![brave_56vDQEGkPX.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
![brave_4BqRRY4SOk.png](./ai-agent-examples/brave_4bqrry4sok.png)
...
**Tip:** Use AutoRAG-style integrations for assistants that can reason over your documents and give context-aware, accurate replies — without hosting your own vector database or embeddings pipeline.
