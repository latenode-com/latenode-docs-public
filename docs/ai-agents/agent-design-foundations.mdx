...
description: How instructions and tools shape agent behavior — core ideas for reliable, task-oriented agents.
sidebar_position: 1
...
![brave_JMGq4SJCaa.png](./agent-design-foundations/brave_coiqwpmi3s.png)
...
![brave_CoiQwPMI3S.png](./agent-design-foundations/brave_coiqwpmi3s.png)
...
![WDADesktopService_6szsCoof3M.png](./agent-design-foundations/wdadesktopservice_6szscoof3m.png)
...
![brave_ZHO76IKiB7.png](./agent-design-foundations/brave_coiqwpmi3s.png)
...
![brave_uskvi2zwEO.png](./agent-design-foundations/brave_coiqwpmi3s.png)
